...
const ContactForm = () => {
  return (
    <>
      <section
        className="bg-gradient-top dark:bg-gradient-top-dark text-text-color dark:text-text-color-dark"
        id="contact"
      >
              ...
              >
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    <input
                      name="phone"
                      className="w-full rounded-lg border-gray-200 p-3 text-sm bg-gradient-bottom dark:bg-gradient-bottom-dark dark:text-white"
